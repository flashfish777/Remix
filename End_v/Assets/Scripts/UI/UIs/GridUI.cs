...
public class GridUI : UIBase
{
    ...
    private void Update()
    {
        ...
        if (runningCoroutines == 0)
        {
            ...
            if (isClothesComplete)
            {
                UIManager.Instance.GetUI<GamingUI>("GamingUI").ShowCompleteBtn();
            }
    ...
    {
        AudioManager.Instance.PlayIntf("UI_grid_move_01");
    ...
    {
        AudioManager.Instance.PlayIntf("UI_grid_move_02");
    ...
    private IEnumerator AddElementCoroutine(int index, ElementType type)
    {
        ...
        int shape = GridManager.Instance.getElement(index).amount;

        if (isBomb == 1)
        {
            AudioManager.Instance.PlayEffect("UI_removeclick");

            switch (type)
            {
                case ElementType.Gold:
                    AudioManager.Instance.PlayEffect("UI_remove_mental_m");
                    break;
                case ElementType.Wood:
                    AudioManager.Instance.PlayEffect("UI_remove_Wood_s_02");
                    break;
                case ElementType.Water:
                    AudioManager.Instance.PlayEffect("UI_remove_water_l_02");
                    break;
                case ElementType.Fire:
                    AudioManager.Instance.PlayEffect("UI_remove_fire_l_01");
                    break;
                case ElementType.Earth:
                    AudioManager.Instance.PlayEffect("UI_remove_stone_s");
                    break;
            }
        ...
        else
        {
            ...
            {
                case ElementType.Gold:
                    AudioManager.Instance.PlayEffect("UI_remove_mental_l");
                    break;
                case ElementType.Wood:
                    AudioManager.Instance.PlayEffect("UI_remove_Wood_l_01");
                    break;
                case ElementType.Water:
                    AudioManager.Instance.PlayEffect("UI_remove_water_s_02");
                    break;
                case ElementType.Fire:
                    AudioManager.Instance.PlayEffect("UI_remove_fire_s_01");
                    break;
                case ElementType.Earth:
                    AudioManager.Instance.PlayEffect("UI_remove_stone_s");
                    break;
